...
export default function ReactPdfHighlighter() {
  ...
  function decorateHighlight(i: IHighlight) {
    i.position.boundingRect.width = size.width
    i.position.boundingRect.height = size.height
    i.position.rects = [i.position.boundingRect]
    console.log('decorateHighlight', i)
  }

  function handleSetHighlight01() {
    decorateHighlight(h1)
    setHighlights([h1])
    scrollViewerTo.current(h1)
  }

  function handleSetHighlight02() {
    decorateHighlight(h2)
    setHighlights([h2])
    scrollViewerTo.current(h2)
  }

  function handleSetHighlight03() {
    decorateHighlight(h3)
    setHighlights([h3])
    scrollViewerTo.current(h3)
  }
    ...
    <div className="fa-main">
      <div className="fa-panel">
        <Flex gap="middle" vertical>
          <Button onClick={handleSetHighlight01}>Highlight 01</Button>
          <Button onClick={handleSetHighlight02}>Highlight 02</Button>
          <Button onClick={handleSetHighlight03}>Highlight 03 And Scroll To Page 3</Button>
        </Flex>
      </div>
      <div className="fa-panel">
        <div className="fa-pdf-container">
          <PdfLoader
            url="/plugins/pdfjs/test2.pdf"
              ...
              return (
                <PdfHighlighter
                  ...
                  highlightTransform={(
                    ...
                    return (
                      <Popup
                        popupContent={<div style={{background: 'white'}}></div>}
